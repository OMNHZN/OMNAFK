...
```jsonc
{
  ...
  "update": {
    ...
    "latest_tag": "v0.1.10",
    "title": "OMNAFK v0.1.10",
    "url": "https://github.com/OMNHZN/OMNAFK/releases/tag/v0.1.10",
    "published_at": "2026-06-10T20:00:00Z",
    "prerelease": false,
    "update_available": true,
    "asset_name": "OMNAFK-Setup.exe",
    "asset_url": "https://github.com/OMNHZN/OMNAFK/releases/download/v0.1.10/OMNAFK-Setup.exe",
  ...
  "config": {
    ...
    "ignored_update_tag": "v0.1.9" | null,
    "pinned": false,
