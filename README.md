...
- Sends real keyboard/mouse input (`SendInput`) by default for better game compatibility.
...
New stable version tags, such as `v0.1.9`, build and attach the custom setup executable to GitHub Releases.
